...
Redis를 이용해 상품 정보의 캐싱 기능을 도입하여 **데이터 접근의 효율성을 향상**시켰습니다. 이로 인해 데이터베이스의 서버 부하를 줄이고 인프라 비용을 절감하며 사용자에게 월등히 빠른 서비스 경험을 제공할 수 있게 되었습니다.<br/>

<details>
<summary>Redis 성능 테스트</summary>
<div markdown="1">
...
<img width="630" alt="스크린샷 2023-08-10 오후 11 24 50" src="https://github.com/CHEESECHOUX/Nest.js-Shoppingmall-Project/assets/89918678/73db15b9-6388-4154-9b14-27df8a003e7b">

<br/>

- Database(AWS RDS MySQL)

<img width="633" alt="스크린샷 2023-08-10 오후 11 24 29" src="https://github.com/CHEESECHOUX/Nest.js-Shoppingmall-Project/assets/89918678/8e012a6e-3e00-456c-8f11-fb9c6dfd134d">

<br/>
</div>
</details>

- Redis 적용 이후 응답 시간은 **중간값 기준으로 1620배 빠르게 개선**되었으며, 상위 95%의 요청에서는 **705.2배의 속도 향상**을 기록했습니다.<br/>
- 전체 요청 처리 시간에서 Redis 활용 시 11초를 기록하여 데이터베이스를 사용 시 15초에 비해 **4초** 더 짧게 걸렸습니다.
<br/>

그러나 캐싱의 특성상 데이터의 신선도에 대한 고려가 필요합니다. 이를 대비해 다음과 같은 해결책을 구현하였습니다.

- 데이터의 신선도를 유지하기 위해 **1시간 만료 시간 설정**<br/>
- **상품 정보 업데이트 시 해당 상품 및 관련 카테고리의 캐시를 삭제**함으로써 사용자에게 항상 최신 정보를 제공하도록 구현했습니다.
<br/>
<br/>
